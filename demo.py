...
def main(args):
    ...
    dense_flag = args.opt in ('2d_dense', '3d', 'depth', 'pncc', 'uv_tex', 'ply', 'obj', 'pure_3d')
    ...
    elif args.opt == 'pure_3d':
        # 创建纯黑色背景
        black_bg = np.zeros_like(img)
        render(black_bg, ver_lst, tddfa.tri, alpha=1.0, show_flag=args.show_flag, wfp=wfp)
    elif args.opt == 'depth':
...
if __name__ == '__main__':
    ...
    parser.add_argument('-o', '--opt', type=str, default='2d_sparse',
                        choices=['2d_sparse', '2d_dense', '3d', 'pure_3d', 'depth', 'pncc', 'uv_tex', 'pose', 'ply', 'obj'])
